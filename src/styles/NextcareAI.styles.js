...
// 테마 색상
export const THEME_COLOR = "#5F487A";

// 히어로 배너 배경 이미지
export const HERO_BG_IMAGE = "/solution04.png";
...
export const ReferenceGrid4 = styled.div`
  display: grid;
...
export const ReferenceImageArea = styled.div`
  width: 100%;
  height: 200px;
  background: linear-gradient(135deg, #f3e9f7 0%, #e8dff5 100%);
  display: flex;
  align-items: center;
