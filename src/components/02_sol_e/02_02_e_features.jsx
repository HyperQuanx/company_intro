...
const E_features = () => {
  const benefits = [
    "에너지 절감을 유도, 효율적인 에너지 소비를 위한 목표관리 등의 에너지 경영을 위한 시스템 제공",
    "스마트 미터를 통해 측정된 데이터를 가공, 건물 에너지 사용량과 증감현황 등을 실시간 확인 및 비교분석 가능",
    "관리자의 업무 프로세스 향상을 위한 모니터링 및 에너지 대시보드, 정보 가시화, 정보 통계 관리 가능",
  ];
